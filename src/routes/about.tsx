...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plus Facilities is a trusted facility management company in Addis Ababa, Ethiopia — delivering cleaning, window cleaning, landscaping, pest control and event support with trained teams and modern systems." },
