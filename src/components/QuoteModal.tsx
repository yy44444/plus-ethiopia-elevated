        ...
        >
          ...
          >
            ...
            {sent ? (
              ...
              <>
                <p className="text-xs uppercase tracking-[0.2em] text-accent">Get a Quote</p>
                <h3 className="mt-2 text-2xl">Tell us about your facility</h3>
                <p className="mt-1 text-sm text-muted-foreground">A specialist will respond within one business day.</p>
                <form
                  className="mt-6 grid gap-4"
                  onSubmit={(e) => { e.preventDefault(); setSent(true); }}
                >
                  <div className="grid gap-4 sm:grid-cols-2">
                    <input required placeholder="Full name" className="rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-primary transition" />
                    <input required type="tel" placeholder="Phone" className="rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-primary transition" />
                  </div>
                  <input required type="email" placeholder="Email address" className="rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-primary transition" />
                  ...
                  <textarea rows={3} placeholder="Tell us about your needs…" className="rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-primary transition" />
